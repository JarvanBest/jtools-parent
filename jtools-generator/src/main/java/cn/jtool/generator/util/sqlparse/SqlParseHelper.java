package cn.jtool.generator.util.sqlparse;


import cn.jtool.generator.util.GLogger;
import cn.jtool.generator.util.IOHelper;
...
public class SqlParseHelper {
	...
	/** 解析sql的别名,如 basic as u,将返回 user及u */
...
//	static_old Pattern p = Pattern.compile("(:)(\\w+)(\\|?)([\\w.]+)");
	...
	public static String convert2NamedParametersSql(String sql, String prefix, String suffix) {
	 ...
	 /**
     * 将sql从占位符转换为命名参数,如 select * from basic where id =? ,将返回: select * from basic where id = #id#
     * @param sql
